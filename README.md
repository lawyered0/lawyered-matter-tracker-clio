...
### Matter Tracker
The CRM engine. "New matter Smith" triggers a full Gmail search + folder scan, builds a chronological timeline, runs a conflict check, adds the matter to the spreadsheet, **and syncs the contact + flat-fee matter to Clio in a single call**. "Update matter Smith" pulls new activity since the last update and merges it in (tracker only — no Clio touch). "Close matter Smith" finalises and moves the row to the Closed Matters sheet (tracker only). Always confirms before writing.
